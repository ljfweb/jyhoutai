  ...
  <div>
    ...
    <div class="cart_wrap">
      <div class="shop" v-for="(item, index) in cartlist" :key="index">
        ...
        <div class="shop_list">
          <van-swipe-cell
            v-for="(goodsitem, gindex) in item.shop"
            :key="gindex"
          >
            <div class="shop_one">
              <van-checkbox
                v-model="goodsitem.is_checked"
                @change="check(goodsitem.is_checked, goodsitem)"
              ></van-checkbox>
              <img :src="goodsitem.goods_pic" alt="" />
              <div class="goods_info">
                ...
                <div class="price">
                  ...
                  <van-stepper
                    @change="updatenum(goodsitem.goods_num, goodsitem)"
