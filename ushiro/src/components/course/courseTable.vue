      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            >{{ scope.row.isTop==true?"已置顶":"置顶" }}</el-button
          >
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    ...
    getCourse(pageStart, searchText, CategoryOne, CategoryTwo, CategoryThree) {  //获取课程
      this.axios({
